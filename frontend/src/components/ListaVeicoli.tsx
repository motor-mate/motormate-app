...
const ListaVeicoli: React.FC<ListaVeicoliProps> = ({ cards }) => {
  return (
    <div className="flex flex-col items-center">
      ...
      <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" type="button" className="w-full max-w-2xl m-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50">
        Aggiungi veicolo
      </button>
